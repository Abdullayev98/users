    ...
    <div class="md:container mx-auto pt-5 mt-[30px]">
        <div class="w-full px-12 md:flex md:grid-flow-row md:justify-center md:mx-auto md:max-w-[1300px] pb-[130px]">
            ...
            <div class="md:w-9/12 md:mt-2 md:pl-12">
                ...
                <p class="my-5">YouDo — это удобное мобильное приложение и сайт для заказа любых услуг напрямую у специалистов и поиска клиентов.</p>
                <p class="my-5">Пользователи YouDo ежедневно решают свои бытовые и рабочие задачи, находят заказы и подработку. Сервис помогает миллионам людей экономить деньги и время, делегировать рутинные дела, которые отвлекают от важного. А ещё YouDo меняет рынок труда, позволяя людям работать в удобное время, без начальников и офиса.</p>
                <p class="my-5">Сейчас на сервисе зарегистрированы 5,9 млн пользователей, из которых более 1 млн сами оказывают услуги. На YouDo легко найти курьера, сантехника, визажиста или бригаду для ремонта. Заказать разработку сайта, организовать свадьбу, переезд и найти исполнителей для тысячи других задач.</p>
