    ...
    <div class="md:container mx-auto pt-5">
        <div class="w-full px-12 md:flex md:grid-flow-row md:justify-center md:mx-auto md:max-w-[1000px] pb-[130px]">
            ...
            <div class="md:w-8/12 mt-8">
                ...
                <a href="http://127.0.0.1:8000/categories/1" class="inline-block mt-7 border-0 outline-0 text-center whitespace-nowrap min-w-[100px] rounded-[8px] text-[2rem] h-[3.5rem] text-white px-[23px] bg-[linear-gradient(180deg,#5dbeff,#4096ef)] hover:bg-[linear-gradient(180deg,#a2d8fc,#6eaff1)">Создать задание</a>
            </div>
        </div>
    </div>
