                ...
                <div class="flex flex-col relative">
                    ...
                    <div class="flex flex-row m-4 absolute bottom-0 left-0">
                        <div class="form-check flex flex- mr-6">
                            <input class="focus:outline-none  form-check-input h-4 w-4 border border-gray-300 rounded-sm bg-white checked:bg-black-600 checked:border-black-600 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer" type="checkbox" value="" onclick="check()" id="online">
