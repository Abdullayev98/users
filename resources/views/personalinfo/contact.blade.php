        ...
        <div class="container p-5">
            ...
            <form action="{{route('verification.contact.store')}}" method="Post" class="my-10">
                ...
                <div class="mt-3">
                    ...
                    <input type="text" id="name" value="{{auth()->user()->phone_number}}" name="phone_number" class="block px-2 w-full border  border-grey-300 py-2 rounded-lg shadow-sm focus:outline-none focus:border-indigo-200 focus:ring focus:ring-indigo-500" />
                </div>
