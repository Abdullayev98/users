...
@section('content')
        ...
        <div class="mt-3 text-center">
            ...
            <div class="mt-4 flex flex-row justify-center">
                <button class="w-40 h-12 rounded-lg bg-red-500 text-gray-200 uppercase font-semibold hover:bg-red-700 text-gray-100 transition mb-4 mr-4"> Google</button>
                <button class="w-40 h-12 rounded-lg bg-blue-500 text-gray-200 uppercase font-semibold hover:bg-blue-700 text-gray-100 transition mb-4"> Facebook</button>
            </div>
            <div class="mx-auto flex items-center justify-center w-full">
