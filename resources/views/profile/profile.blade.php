...
@section("content")
                    ...
                    <div class="grid md:grid-cols-10 w-full">
                        <ul class=" md:col-span-9 items-center w-3/4 md:w-full" id="tabs">
                            <li class=" md:mr-5 mr-1 inline-block"><a href="/profile"
                                                                      class=" md:text-[18px] text-[14px] font-bold block text-gray-700"
                                                                      id="default-tab">@lang('lang.cash_aboutMe')</a>
                            </li>
                            <li class=" md:mr-5 mr-1 inline-block"><a href="/profile/cash"
                                                                      class=" md:text-[18px] text-[14px] text-gray-600">@lang('lang.cash_check')</a>
                            </li>
                        ...
                        <div class="md:col-span-1 md:block hidden text-gray-600" id="settingsIcon"><a
                                href="/profile/settings"><i class="fas fa-user-cog text-3xl"></i></a></div>
                        ...
                        <div class="about-a-bit mt-10">
                            ...
                            @if ($user->description == Null)
                                <span class="ml-10">
                                        ...
                                        <p class="inline text-gray-500 cursor-pointer"
                                           id="padd">@lang('lang.profile_add')</p>
                                    </span>
                            ...
                            @else
                                <span class="ml-10">
                                        <i class="fas fa-pencil-alt inline text-gray-700"></i>
                                        <p class="inline text-gray-500 cursor-pointer"
                                           id="padd">@lang('lang.profile_edit')</p>
                                    </span>
                            ...
                            <form action="{{route('edit.description')}}" method="POST" class="formdesc hidden">
                                ...
                                <textarea name="description" name="description"
                                          ...
                                          @if (!$user->description) placeholder="Enter description"@endif >@if ($user->description){{$user->description}}@endif
                                    </textarea><br>
                                <input type="submit"
                                       class="bg-blue-400 hover:bg-blue-500 text-white py-2 px-6 rounded cursor-"
                                       id="s1" value="@lang('lang.profile_save')">
                                <a id="s2"
                                   class="border-dotted border-b-2 mx-4 pb-1 text-gray-500 hover:text-red-500 hover:border-red-500"
                                   href="">@lang('lang.profile_cancel')</a>
                            </form>
                        </div>
                        <h4 class="font-bold mt-5 text-gray-700">@lang('lang.profile_workExample')</h4>
                        <div class="example-of-works w-full mx-auto my-10 ">
                            <a onclick="toggleModal123('modal-id123')"
                               class="bg-yellow-500 px-8 py-3 rounded-md text-white text-2xl" href="#">
                                <i class="fas fa-camera"></i>
    ...
    <div
        ...
        style="background-color: rgba(0, 0, 0,0.5)" id="modal-id123">
        <div class="relative my-6 mx-auto max-w-3xl" id="modal11">
            <div
                ...
                <div class=" text-center p-6  rounded-t">
                    <button type="submit" onclick="toggleModal123('modal-id123')"
                ...
                <div class="text-center h-64 w-80 text-base">
                    <form action="#" enctype="multipart/form-data">
                        ...
                        <input type="submit"
                               class="bg-yellow-400 hover:bg-yellow-500 text-white py-2 px-6 rounded cursor-"
