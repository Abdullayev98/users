        ...
        <div class="w-7/12">
            <div>
                ...
                <div id="comdes" class="bg-yellow-50 p-8 rounded-md my-6">
                    ...
                    <input name="comment" class="border focus:outline-none mb-6 text-sm border-gray-200 rounded-md w-full px-4 py-2" type="text" placeholder='@lang('lang.profile_text5')'>

                    <label class="text-sm text-gray-500" for="textarea">@lang('lang.profile_text4')</label><br>
                    <input name="description"  required class="border text-sm mb-8 focus:outline-none border-gray-200 rounded-md w-full px-4 py-2" type="textarea" placeholder='@lang('lang.profile_text6')'>
                    <div class="text-center h-full w-full text-base">
                    <input id="button1" type="submit" class="bg-green-500 hover:bg-green-700 text-white py-2 px-10 w-4/12 mb-4 rounded" value="@lang('lang.profile_text7')">
                    </div>
                </div>
