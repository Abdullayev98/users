...
<div class="md:container mx-auto pt-5">
    <div class="flex grid-flow-row justify-center mx-auto max-w-[1000px] pb-[130px]">
        <div class="md:w-3/12 h-auto mt-5">
            <ul>
                <li>
        ...
        <div class="md:w-7/12">
            <h1 class="text-[2rem] pb-2 font-semibold">
            ...
            <p class="pb-[20px] text-[14.7px] leading-[1.4rem]">Мы рады, что каждый из исполнителей присоединился к сервису, и гордимся командой наших проверенных пользователей. А их отзывы о нашей работе доказывают, что мы делаем действительно полезный и необходимый для многих продукт.</p>
            <ul class="pt-[20px]">
                <li class="">
