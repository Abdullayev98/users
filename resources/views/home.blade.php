...
<div class="bg-[url('https://assets.youdo.com/next/_next/static/images/frame-51209c6822214bfb9166eb41c4dec591.jpg')] bg-center bg-cover h-96 ">
    ...
    <main>
      ...
      <div class="w-full mx-auto lg:shadow-xl">
        <div class="grid md:grid-cols-2 grid-cols-1 mx-auto h-auto md:bg-none bg-contain bg-right bg-no-repeat bg-[url('https://assets.youdo.com/next/_next/static/images/download_hand-13ced686918d5e0b8a92914b8cc87aaf.png')]">
          <div class="grid md:grid-cols-2 grid-cols-1 mx-auto h-auto md:bg-none bg-[#00000066]">
              <h4 class="text-3xl md:text-[#000] text-[#ffff]">Персональный помощник в вашем кармане</h4>
              <p class="text-md mt-8 md:text-[#000] text-[#ffff]">Скачайте наше приложение и пользуйтесь YouDo, где бы вы ни находились.</p>
                <a href="#"><button type="button" class="w-3/10 bg-[#000] hover:bg-[#ffa200] rounded-md mt-8"><img src="https://assets.youdo.com/_next/static/media/ios.d3a42dd0816a046400b4bb7d2b11067f.svg" alt=""> </button></a>
                <a href="#"><button type="button" class="w-3/10 bg-[#000] hover:bg-[#ffa200] rounded-md mt-8"><img src="https://assets.youdo.com/_next/static/media/android.1234ba9391753eeb525d4f71a808329e.svg" alt=""> </button></a>
                <a href="#"><button type="button" class="w-3/10 bg-[#000] hover:bg-[#ffa200] rounded-md mt-8"><img src="https://assets.youdo.com/_next/static/media/appgallery.67baccf681decda41c84b0364830d2e4.svg" alt=""> </button></a>
          </div>
      ...
      <div class="container mx-auto md:w-2/3 w-11/12">
        ...
        <div class="grid md:grid-cols-3 grid-cols-2 mx-auto">
          <div class="col-span-2 mx-auto w-10/12 md:my-16 h-96 blog1 bg-cover bg-no-repeat bg-[url('https://content0.youdo.com/zi.ashx?i=d36fd188a176881f')]">
          ...
          <div class="mx-auto md:col-span-1 col-span-2 md:w-full w-10/12 h-96 md:my-16 my-8 blog1 bg-[url('https://content9.youdo.com/zi.ashx?i=cf53596d9aeb5742')]">
            <div class="w-full h-full bg-[#00000066]">
              <div class="text-xs text-[#ffff] ml-4 pt-64 h-4">
                Спецпроекты
              </div>
        ...
        <div class="grid md:grid-cols-6 grid-cols-2 mx-auto">
            <div class="col-span-3 md:w-4/5 w-10/12 mb-8 mx-auto h-96 blog1 bg-[url('https://content7.youdo.com/zi.ashx?i=9acd814387dbd28f')]">
            <div class="w-full h-full bg-[#00000066]">
              <div class="text-xs text-[#ffff] ml-4 pt-64 h-4">
                Спецпроекты
              </div>
            ...
            <div class="col-span-3 md:w-full w-10/12 md:ml-auto mx-auto h-96 blog1 bg-cover bg-no-repeat bg-[url('https://content0.youdo.com/zi.ashx?i=d3b9516659746950')]">
              <div class="w-full h-full bg-[#00000066]">
                <div class="text-xs text-[#ffff] ml-4 pt-64 h-4">
                  Спецпроекты
                </div>
    ...
    <div class="container mx-auto md:w-2/3 w-11/12">
      <div class="w-full my-16">
        ...
        <div class="grid md:grid-cols-3 grid-cols-2 mx-auto h-screen">
          <div class="col-span-2 md:w-10/12 w-full h-full blog1 mt-8">
