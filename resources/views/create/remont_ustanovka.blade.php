      ...
      <div class="py-4 mx-auto  text-left ">
        ...
        <div>
            ...
            <div class="mb-3 xl:w-full">
                ...
                <label class="md:w-2/3 block mt-6">
                    <input class="mr-2  h-4 w-4" type="radio" value="{{$category}}" name="remont_ustanovka">
        ...
        <div class="mt-4">
            <div class="flex w-full gap-x-4 mt-4">
             <a href="/task/create/name" type="button"  class="w-1/3  border border-[#000]-700 hover:border-[#000] transition-colors rounded-lg py-2 text-center flex justify-center items-center gap-2">
