                    ...
                    <ul>
                        ...
                        <li class="mb-1">
                            <div class="max-w-lg mx-auto ml-6">
                                <button class="" type="button" data-dropdown-toggle="dropdown3"><i class="text-2xl mr-6 text-slate-400 hover:text-orange-500 far fa-bell"></i>
                                </button>
                                <!-- Dropdown menu -->
                                <div class="hidden bg-white text-base z-50 list-none divide-y divide-gray-100 rounded shadow my-4" id="dropdown3">
                                    <div class="px-4 py-3">
                                        <span class="block text-base font-bold">Уведомления</span>
                                    </div>
                                       <ul class="py-1" aria-labelledby="dropdown3">
                                            <li>
                        ...
                        <li class="mb-1">
                            <div class="max-w-lg mx-auto ml-6">
                                <button class="" type="button" data-dropdown-toggle="dropdown2"><i class="text-2xl text-slate-400 hover:text-orange-500  far fa-user"></i>
                                </button>
                                <!-- Dropdown menu -->
