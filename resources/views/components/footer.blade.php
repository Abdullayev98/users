<footer class=" w-10/12 mx-auto">
    <div class="md:flex sm:flex-row flex-col my-8 text-base">
        <div class="w-1/2 w-full flex md:flex-row flex-col md:text-left text-center md:my-0 my-10">
            <div class="w-3/4 flex flex-col lg:mx-8 mx-auto">
                <a class="delete-task verification cursor-pointer text-gray-700 hover:text-yellow-500 border-b-2 md:border-0 hover:border-yellow-500 verify" href="/verification">{{__('Как')}}&nbsp;{{__('стать')}}&nbsp;{{__('исполнителем')}}</a>
                <a class="delete-task faq cursor-pointer text-gray-700 hover:text-yellow-500 border-b-2 md:border-0 hover:border-yellow-500" href="/faq">{{__('Часто задаваемые вопросы')}}</a>
                <a class="delete-task contact cursor-pointer text-gray-700 hover:text-yellow-500 border-b-2 md:border-0 hover:border-yellow-500 contact" href="/contacts">{{__('Контакты')}}</a>
            </div>
            <div class="w-3/4 flex flex-col lg:mx-0 mx-auto">
                <a class="delete-task review cursor-pointer text-gray-700 hover:text-yellow-500 border-b-2 md:border-0 hover:border-yellow-500 rews" href="/author-reviews">{{__('Отзывы заказчиков')}}</a>
                <a class="text-gray-700 hover:text-yellow-500 border-b-2 md:border-0 hover:border-yellow-500" href="#replain-link">{{__('Служба поддержки')}}</a>
            </div>
        </div>
    ...
    <div class="md:flex md:mx-0 mx-auto border-t pt-4">
        <div class="container mx-auto sm:ml-4 ml-0 mb-4 md:text-left text-center">
            <span class="">
            {{__('© 2022 Universal services (user.uz')}} <br>
