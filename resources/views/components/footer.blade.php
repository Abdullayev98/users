    ...
    <footer class="h-auto md:pt-9">
        ...
        <div class="md:pb-10 flex justify-between items-center">
            <div class="leading-[20px] text-[12px] tracking-[.2px] text-[#a199aa]">© <!-- -->2021<!-- --> YouDo <span>(youdo.com, youdo.ru, юду.рф)</span> <b>·</b>
                <a href="../terms/terms.blade.php" class=" hover:text-[#ffa200]">Правила сервиса</a>
            </div>
            <div class="w-[218px] right-8">
                <div class="flex justify-between items-center ">
                    <a href="https://www.facebook.com/" target="_blank" rel="noopener noreferrer" class="fab fa-facebook text-[#a199aa] hover:text-[#ffa200] block w-[24px] h-[24px]">

                    </a>
                    <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer" class="fab fa-instagram text-[#a199aa] hover:text-[#ffa200] block w-[24px] h-[24px]">

                    </a>
                    <a href="https://twitter.com/" target="_blank" rel="noopener noreferrer" class="fab fa-twitter block text-[#a199aa] hover:text-[#ffa200] w-[24px] h-[24px]">

                    </a>
                    <a href="https://vk.com/" target="_blank" rel="noopener noreferrer" class="fab fa-vk block w-[24px] text-[#a199aa] hover:text-[#ffa200] h-[24px]">

                    </a>
                    <a href="https://www.youtube.com/user/" target="_blank" rel="noopener noreferrer" class="fab fa-youtube text-[#a199aa] hover:text-[#ffa200] block w-[24px] h-[24px]">
