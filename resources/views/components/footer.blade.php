    ...
    <div class="p-10 text-gray-800">
        <div class="mx-auto text-center md:text-left">
            <div class="grid-col-1 md:grid-col-2 lg:grid-col-4 gap-x-2">
                <div class="mb-5 md:w-2/12 md:mr-12 w-full float-left">
                    <a href="https://sk.ru/" class="block w-28 mx-auto h-16 md:mr-8 hover:opacity-80 bg-cover bg-center  bg-[url('https://assets.youdo.com/_next/static/media/sk.1f99725347d9445a272bcc3acd248ad8.svg')]" target="_blank" rel="noopener noreferrer"></a>
                </div>
                ...
                <div class="mb-5 md:w-2/12 md:float-left -mt-5 md:m-0">
                    <a class="text-[#5f5869] hover:text-[#ffa200] border-b-2 md:border-0 border-b-[#ffa200]" href="/verification">YouDo для бизнеса</a><br>
                    <a class="text-[#5f5869] hover:text-[#ffa200] border-b-2 md:border-0 border-b-[#ffa200]" href="/verification">Наш блог</a><br>
                    <a class="text-[#5f5869] hover:text-[#ffa200] border-b-2 md:border-0 border-b-[#ffa200]" href="/verification">Служба поддержки</a>
                </div>
