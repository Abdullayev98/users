       ...
       <div class="mx-auto text-center md:text-left">
           <div class="grid-col-1 md:grid-col-2 lg:grid-col-4 gap-x-2">
               ...
               <div class="mb-5 md:w-2/12 md:float-left -mt-5 md:m-0">
                   ...
                   <!-- <a class="text-[#5f5869] hover:text-[#ffa200] border-b-2 md:border-0 border-b-[#ffa200]" href="#">User для бизнеса</a><br>
               ...
               <div class="mb-5 md:float-left mx-auto lg:float-none md:w-6/16">
                   <div class="w-1/1 ml-auto px-auto">
                       ...
                       <!-- <a class="md:mr-2 rounded-md lg:inline-block" rel="noopener noreferrer" href="https://appgallery.cloud.huawei.com/ag/n/app/C101747675?locale=ru_RU&amp;channelId=user&amp;id=424fff149df14f2c9f75123706820d5e&amp;s=4DFA8AAFD6CA4AA004756257A93CE9BC6E6F07E2AE3564259878D059C9C07573&amp;detailType=0&amp;v=" target="_blank">
                           <button type="button" class="w-3/10 bg-[#000] rounded-md mt-8 hover:bg-[#ffa200]"><img src="https://assets.user.com/_next/static/media/appgallery.67baccf681decda41c84b0364830d2e4.svg" alt=""> </button>
                       </a> -->
                   </div>
               </div>
