<div class="bg-gray-100 bg-center bg-cover mt-4 h-40 py-4 hidden md:block">
    <div class="row-start-2 row-span-2 2xl:w-4/5 w-full mx-auto h-full">
        <div class="grid grid-cols-3 gap-2 lg:gap-6 h-full">
            <div class="text-left h-full">
                <div class="grid grid-cols-3 h-full">
                    <div class="step w-full text-center h-full text-8xl pt-4 text-gray-500">1</div>
                    <div class="w-full col-span-2">
                        <div class="text-left text-sm lg:text-base xl:text-xl font-bold pt-4 w-full h-1/2 text-gray-800">@lang('lang.roadmap_describeatask')</div>
            ...
            <div class="text-left h-full">
                <div class="grid grid-cols-3 h-full">
                    ...
                    <div class="w-full col-span-2">
                        <div class="text-left text-sm lg:text-base xl:text-xl font-bold pt-4 w-full h-1/2 text-gray-800">@lang('lang.roadmap_text1')</div>
            ...
            <div class="text-left h-full">
                <div class="grid grid-cols-3 h-full">
                    ...
                    <div class="w-full col-span-2">
                        <div class="text-left text-sm lg:text-base xl:text-xl font-bold pt-4 w-full h-1/2 text-gray-800">@lang('lang.roadmap_text3')</div>
