        ...
        <div class="grid grid-cols-3 gap-6 h-full">
            <div class="text-left h-full">
                <div class="grid grid-cols-3 h-full">
                    ...
                    <div class="w-full col-span-2">
                        <div class="text-left text-xl font-bold pt-4 w-full h-1/2 text-gray-800">@lang('lang.roadmap_describeatask')</div>
            ...
            <div class="text-left h-full">
                <div class="grid grid-cols-3 h-full">
                    ...
                    <div class="w-full col-span-2">
                        <div class="text-left text-xl font-bold pt-4 w-full h-1/2 text-gray-800">@lang('lang.roadmap_text1')</div>
            ...
            <div class="text-left h-full">
                <div class="grid grid-cols-3 h-full">
                    ...
                    <div class="w-full col-span-2">
                        <div class="text-left text-xl font-bold pt-4 w-full  text-gray-800">@lang('lang.roadmap_text3')</div>
