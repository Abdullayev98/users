            ...
            <div class="col-span-4 ml-1">
                    <div class="w-full">
                        <div class="w-4/5">
                            ...
                            <br>
                            <p class="">Мы приложили максимум усилий, чтобы поиск исполнителя на Universal Services был удобным и безопасным.</p>
                        </div>
                        <div class="grid grid-cols-10">
                            ...
                            <div class="col-span-7 p-5">
                                ...
                                <p class="mt-5">При оплате задания через Сделку без риска Universal Services гарантирует возврат денег, если что-то пойдет не так, а исполнитель может быть уверен, что получит согласованную оплату без задержек.</p>
                                <p class="mt-5">Также Universal Services компенсирует до 10 000 рублей, если в результате действий исполнителя заказчику причинен материальный ущерб.</p>
                        ...
                        <div class="grid grid-cols-10 h-96 ">
                            <div class="col-span-7 p-5 my-auto" >
                                ...
                                <p class="w-full">Все исполнители заполняют анкету и проходят проверку сервиса. Мы не регистрируем      подозрительные и мошеннические аккаунты. Те, кто прошел автоматическую проверку документов на Universal Services, получают значок «Документы подтверждены».
                                </p>
                        ...
                        <div class="w-full mt-10">
                            ...
                            <p>Исполнители не являются сотрудниками Universal Services и несут личную ответственность за качество своей работы. При сотрудничестве с любым исполнителем, даже если он подтвердил паспорт или вы нашли его не на нашем сервисе, мы рекомендуем всегда соблюдать базовые правила безопасности.</p>
                            <ul class="mt-5 list-decimal ml-10">
                                <li class="mr-5">Внимательно изучите отзывы и примеры выполненных заданий.</li>
                                <li class="mr-5">Перед началом работы попросите исполнителя показать паспорт, сверьте имя в профиле на Universal Services и в документе.</li>
