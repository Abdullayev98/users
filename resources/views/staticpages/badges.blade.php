                ...
                <div class="w-full">
                    ...
                    <div class="bg-gray-200">
                        ...
                        <div class="grid grid-cols-5">
                            ...
                            <div class="col-span-4">
                                <p class="mt-5"><span class="text-red-500 italic">Услуги исполнителя застрахованы</span>. Исполнитель подключил услугу страхования материальной ответственности на YouDo. Если во время выполнения задания что-то сломается или будет нанесён другой материальный ущерб, ВСК выплатит заказчикам компенсацию до 100 тыс. рублей.</p>
                            </div>
                        </div>
                        <div></div>
                    </div>
