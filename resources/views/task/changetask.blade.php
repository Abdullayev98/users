...
@section("content")
    ...
    <div class="xl:w-8/12 lg:10/12  mx-auto lg:flex mt-4 md:mt-8">
        <div class="lg:w-8/12 w-11/12 mx-auto bg-yellow-50 py-6 px-12 rounded-md ">
            ...
            <div class="md:flex">
                <select onchange="func_for_select(Number(this.options[this.selectedIndex].value));" class="mr-4 mb-4  form-select block w-full  px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding bg-no-repeat border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" aria-label="Default select example"">
                ...
                <div class="mb-4">
                    <div id="formulario" class="flex flex-col gap-y-4 text-base">
                        ...
                        <div class="flex items-center bg-white hover:bg-gray-100  rounded-lg border py-1">
                            ...
                            <ymaps style="z-index: 40000; display: block; position: absolute; width: 521px; top: 483.5px; left: 285.35px;"></ymaps><input autocomplete="off" oninput="myFunction()" id="suggest0" class="appearance-none bg-transparent w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none" type="text" placeholder="Город, Улица, Дом" value="" name="location0" required="">
                            <button id="getlocal" class="flex-shrink-0 border-transparent border-4 text-teal-500 hover:text-teal-800 text-sm py-1 px-2 rounded" type="button">   <svg class="h-4 w-4 text-purple-500" width="12" height="12" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  <path stroke="none" d="M0 0h24v24H0z"></path>  <path d="M21 3L14.5 21a.55 .55 0 0 1 -1 0L10 14L3 10.5a.55 .55 0 0 1 0 -1L21 3"></path></svg>  </button>
            ...
            <div class="text-base my-6 bg-white rounded-md shadow-md p-4">
                ...
                <div>
                    <select class="border border-gray-300 rounded-md w-full focus:outline-none py-2 px-4" name="budget" id="budget">
                        <option value="1">
                            1000
                        </option>
                        <option value="1">
                ...
                <div class="my-4 text-base">
                    ...
                    <input class="border border-gray-200 md:mx-4 md:px-2 py-2 pr-2 rounded-md focus:outline-none text-right" placeholder="SUMMA" type="number">SUM
                </div>
            </div>
            <div class="text-base my-4 ">
                <h1 class="text-xl font-semibold py-2">Ваши контакты</h1>
                <input class="text-base border border-gray-200 md:w-1/2 focus:outline-none py-2 px-3 rounded-md" type="text" placeholder="+998 99 999 99 99">
            </div>
            <div class="text-base my-5 mt-8">
                <a href="#" class="text-2xl mr-5 bg-green-500 hover:bg-green-700 text-white px-4 py-2 rounded-md ">Сохранить</a>
                <a href="#" class="text-xl text-blue-500 hover:text-red-500 border-b border-dotted border-blue-500 hover:border-red-500">Отмена</a>
            </div>
        </div>
