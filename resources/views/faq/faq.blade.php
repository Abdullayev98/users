        ...
        <div class="lg:w-8/12 mx-auto w-10/12">
            ...
            <form class="">
                <div class="flex relative mx-auto w-full">
                    ...
                    <input id="inp" class="bg-[#6d6e70] border-none outline-none transition h-16 pl-16 rounded-md focus:outline-none focus:bg-white w-full text-black lg:md:text-base text-base hover:bg-[#7a7b7d]" type="search" name="search" placeholder="Поиск ответов..." />
                </div>
            </form>
        </div>
    </section>
