...
<body class="bg-slate-200">
    ...
    <section class="mt-7 mb-7">
        <div class="w-10/12 lg:w-8/12 mx-auto md:flex flex-row justify-center items-center bg-white py-5 px-8 rounded-md shadow-lg shadow-indigo-400/40">
