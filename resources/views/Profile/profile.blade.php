...
{{-- user ma'lumotlari tugashi --}}
                <div class="content mt-20 relative">
                    <ul class="relative w-9/10">
                        ...
                        <li class="inline mr-10 float-right"><a href="/" class="text-black text-xl"><i class="black fas fa-cogs absolute"></i></a></li>
                        <hr>
                    </ul>
 {{-- "men haqimda" start --}}
...
{{-- hisob --}}     <div class="cash invisible absolute w-full">
                        ...
                        <div class="relative mt-10 p-5 bg-gray-100 w-full block">
                            ...
                            <ul class="mt-5">
                                ...
                                <li class="inline ml-5 underline text-[#0091e6]"><a href="/home/profile">Пополнения счета</a></li>
                                <li class="inline ml-5 underline text-[#0091e6]"><a href="/home/profile">Списания со счета</a></li>
                            </ul>
                        ...
                        <div class="FAQ reltive block w-full mt-5">
                            ...
                            <p>YouDo списывает с исполнителей фиксированную оплату за возможность оставлять к заданиям отклики с контактными данными. Стоимость одного отклика зависит от категории заданий и начинается от 20 рублей. Оплата за отклики не возвращается.</p>
...
{{-- o`ng tomon ispolnitel --}}
            <div class="col-span-1 mx-2 inline-block absolute w-1/5 float-right right-20 rounded-xl ring-1 ring-gray-100 h-auto lg:visible xl:visible md:visible  sm:invisible">
                <div class="mt-6 ml-4">
                ...
                <div class="contacts relative ">
                    <div class="ml-4 h-20 grid grid-cols-4">
                        <div class="w-14 h-14 text-center mx-auto my-auto py-3 rounded-xl col-span-1" style="background-color: orange;">
                    ...
                    <div class="telefon ml-4 h-20 grid grid-cols-4">
                        <div class="w-14 h-14 text-center mx-auto my-auto py-3 rounded-xl col-span-1" style="background-color: #0091E6;" >
                    ...
                    <div class="telefon ml-4 h-20 grid grid-cols-4">
                        <div class="w-14 h-14 text-center mx-auto my-auto py-3 rounded-xl col-span-1"  style="background-color: #4285F4;">
                ...
                <p class="mx-5 my-4">Повысьте доверие пользователей к себе — привяжите ваши аккаунты социальных сетей к профилю Servicebox. Мы обязуемся не раскрывать ваши контакты.</p>
                <div class="telefon ml-4 h-20 grid grid-cols-4">
