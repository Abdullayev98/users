...
public function ref(Request $request){
    ...
    if($request->get("paymethod") == 'Click'){
      ...
      return redirect()->to("https://my.click.uz/services/pay?service_id=19839&merchant_id=14364&amount=$amount.00&transaction_param=$article_id&return_url=http://teampro.uz");
